...
class InstitutionUserLinkServiceImplTest {
	...
	public void testSaveInstitutionUserLinks() throws Exception {
		...
		when(objectMapper.convertValue(institutionUserLinkRequestDTO, InstitutionUserLink.class)).thenReturn(institutionUserLink);
		...
		CommonResponseDTO commonResponse = institutionUserLinkService.saveInstitutionUserLinks(institutionUserLinkRequestDTO);
		assertEquals("SUCCESS", commonResponse.getStatus());
	}
	@Test
	public void testfindAllInstitutionUserLink() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		InstitutionUserLink institutionUserLink1 = mapper.convertValue(institutionUserLinkRequestDTO, InstitutionUserLink.class);
	...
	public void testfindByUserId() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		InstitutionUserLink institutionUserLink2 = mapper.convertValue(institutionUserLinkRequestDTO, InstitutionUserLink.class);
	...
	public void testFindByInstitutionId() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		InstitutionUserLink institutionUserLink3 = mapper.convertValue(institutionUserLinkRequestDTO, InstitutionUserLink.class);
	...
	public void testFetchInstitutionUserLinkByAll() throws Exception{
		...
		List<InstitutionUserLink> institutionUserLink = new ArrayList<InstitutionUserLink>();
		institutionUserLink.add(institutionUserLink1);
		when(institutionUserLinkRepository.findByInstitutionIdANDUserId("abc","abcd")).thenReturn(Optional.of(institutionUserLink1));
		//when(institutionUserLinkRepository.findAll()).thenReturn(institutionUserLink);
	...
	public void testupdateInstitutionUserLink() throws Exception {
		...
		when(institutionUserLinkRepository.findByInstitutionIdANDUserId("cab","abc")).thenReturn(Optional.of(institutionUserLink1));
		when(objectMapper.convertValue(institutionUserLinkRequestDTO, InstitutionUserLink.class)).thenReturn(institutionUserLink);
		when(jwtSecurityContextUtil.getId()).thenReturn("test");
		when(institutionUserLinkRepository.save(institutionUserLink)).thenReturn(institutionUserLink);

		CommonResponseDTO commonResponse = institutionUserLinkService.updateInstitutionUserLink(institutionUserLinkRequestDTO,
				"cab","abc");
		assertEquals("SUCCESS", commonResponse.getStatus());
	}
	@Test
	public void testDeleteInstitutionUserLink() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		InstitutionUserLink institutionUserLink1 = mapper.convertValue(institutionUserLinkRequestDTO, InstitutionUserLink.class);
		when(institutionUserLinkRepository.findByInstitutionIdANDUserId("abc","bac")).thenReturn(Optional.of(institutionUserLink1));
